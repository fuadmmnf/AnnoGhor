...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::post('/admin/add-product', [AdminProductController::class, 'store'])->name('admin.product.store');
    Route::get('/admin/edit-product/{id}', [AdminProductController::class, 'edit'])->name('admin.edit-product');
    Route::post('/admin/update-product/{id}', [AdminProductController::class, 'update'])->name('admin.product.update');
    Route::delete('/admin/delete-product/{id}', [AdminProductController::class, 'destroy'])->name('admin.product.delete');
    ...
    // AJAX Routes
    Route::get('/admin/subcategories/{subcategoryId}/products', [AdminProductController::class, 'getProductsBySubcategory'])->name('admin.get.products');
    Route::get('/admin/categories/{categoryId}/subcategories', [AdminProductController::class, 'getSubcategories'])->name('admin.get.subcategories');
    ...
    Route::post('/admin/add-category', [CategoryController::class, 'store'])->name('admin.category.store');
    ...
    // Headline Routes
    Route::get('/admin/headline-list', [HeadlineController::class, 'index'])->name('admin.headlines.index');
    ...
    // Admin Order Routes
    Route::get('/admin/order-list', [AdminOrderController::class, 'index'])->name('admin.order-list');
    Route::get('/admin/orders/pending', [AdminOrderController::class, 'pending'])->name('admin.orders.pending');
    Route::get('/admin/orders/processing', [AdminOrderController::class, 'processing'])->name('admin.orders.processing');
    Route::get('/admin/orders/shipped', [AdminOrderController::class, 'shipped'])->name('admin.orders.shipped');
    ...
    Route::get('/admin/order-detail/{id}', [AdminOrderController::class, 'show'])->name('admin.order-detail');
    Route::get('/admin/order-tracking/{id}', [AdminOrderController::class, 'tracking'])->name('admin.order-tracking');
    ...
    Route::get('/admin/add-review', [ReviewController::class, 'create'])->name('admin.add-review');
    Route::post('/admin/add-review', [ReviewController::class, 'store'])->name('admin.review.store');
    Route::get('/admin/edit-review/{review}', [ReviewController::class, 'edit'])->name('admin.edit-review');
    Route::put('/admin/update-review/{review}', [ReviewController::class, 'update'])->name('admin.review.update');
    Route::delete('/admin/delete-review/{review}', [ReviewController::class, 'destroy'])->name('admin.review.delete');
    Route::post('/admin/review/{review}/toggle-status', [ReviewController::class, 'toggleStatus'])->name('admin.review.toggle-status');

    // FAQ Routes
    Route::get('/admin/faq-list', [AdminFaqController::class, 'index'])->name('admin.faqs.index');
    Route::get('/admin/add-faq', [AdminFaqController::class, 'create'])->name('admin.faqs.add-faq');
    Route::post('/admin/add-faq', [AdminFaqController::class, 'store'])->name('admin.faqs.store');
    Route::get('/admin/edit-faq/{faq}', [AdminFaqController::class, 'edit'])->name('admin.faqs.edit-faq');
    Route::put('/admin/update-faq/{faq}', [AdminFaqController::class, 'update'])->name('admin.faqs.update');
    Route::delete('/admin/delete-faq/{faq}', [AdminFaqController::class, 'destroy'])->name('admin.faqs.delete');
    Route::post('/admin/faq/{faq}/toggle-status', [AdminFaqController::class, 'toggleStatus'])->name('admin.faqs.toggle-status');

    // Settings Routes
    Route::get('/admin/settings/charge', [SettingController::class, 'charge'])->name('admin.settings.charge');
...
// Currency Routes
Route::get('/currency/switch/{currency}', [App\Http\Controllers\CurrencyController::class, 'switch'])->name('currency.switch');
Route::get('/currency/reset', [App\Http\Controllers\CurrencyController::class, 'reset'])->name('currency.reset');
Route::post('/change-currency', function (\Illuminate\Http\Request $request) {
    $setting = \App\Models\CurrencySetting::getActive();
    $currency = $request->currency;
    if ($currency === $setting->primary_currency || $currency === $setting->secondary_currency) {

                    ...
                    <div class="wg-box">
                        ...
                        <div class="right flex-grow">
                            <fieldset class="name mb-24">
                                ...
                                <input class="flex-grow" type="text" placeholder="Username" name="name" tabindex="0"
                        ...
                        <div class="right flex-grow">
                            ...
                            <fieldset class="mb-24">
                                ...
                                <div class="radio-buttons">
                                    ...
                                    <div class="item">
                                        <input class="" type="radio" name="update-product" id="update-product2"
                                            checked>
                            ...
                            <fieldset class="mb-24">
                                ...
                                <div class="radio-buttons">
                                    <div class="item">
                                        <input class="" type="radio" name="delete-product" id="delete-product1"
                                            checked>
                            ...
                            <fieldset class="mb-24">
                                ...
                                <div class="radio-buttons">
                                    ...
                                    <div class="item">
                                        <input class="" type="radio" name="apply-product" id="apply-product2"
                                            checked>
                            ...
                            <fieldset class="">
                                ...
                                <div class="radio-buttons">
                                    ...
                                    <div class="item">
                                        <input class="" type="radio" name="create-product" id="create-product2"
                                            checked>

        ...
        <div class="main-content-wrap">
            <div class="flex items-center justify-between flex-wrap gap-6 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap gap-3">
                    ...
                    <li><i class="icon-chevron-right"></i></li>
                    <li><div class="text-tiny">Add Review</div></li>
                </ul>
            </div>
            ...
            <form action="{{ route('admin.review.store') }}" method="POST" enctype="multipart/form-data" class="tf-section-2 form-add-product">
                @csrf
                <div class="wg-box">
                    <!-- Reviewer Name -->
                    <fieldset class="name">
                        ...
                        <input type="text" name="reviewer_name" placeholder="Enter reviewer name" 
                               value="{{ old('reviewer_name') }}" required class="mb-10">
                    </fieldset>

                    <!-- Review Text -->
                    <fieldset class="description">
                        <div class="body-title mb-10">Review Text <span class="tf-color-1">*</span></div>
                        <textarea name="review_text" placeholder="Enter review text" rows="4" required class="mb-10">{{ old('review_text') }}</textarea>
                    </fieldset>
                    ...
                    <fieldset class="image">
                        ...
                        <small class="text-tiny">Max: 2MB, JPG/PNG/GIF</small>
                ...
                <div class="wg-box mt-4">
                    ...
                    <fieldset class="status">
                     ...
                     <button type="submit" class="tf-button w-full">Save Review</button>
                    {{--<a href="{{ route('admin.review-list') }}" class="tf-button style-2 w-full mt-2">Cancel</a> --}}
                </div>
            </form>
        </div>
    </div>
